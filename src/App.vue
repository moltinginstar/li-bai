  ...
  <div class="flex flex-col h-screen p-6 sm:p-8">
    <header class="flex flex-row gap-4 items-start">
      ...
      <div>
        ...
        <p class="text-sm text-gray-800 mt-0.5">
          Ճշգրիտ չինարեն-հայերեն տառադարձություն
        </p>
      </div>
    </header>
    ...
    <main class="h-full">
      ...
      <p class="text-xs text-gray-600 mt-1">
        <a
          ...
          href="https://en.wikipedia.org/wiki/Erhua"
          target="_blank"
        >
          Ըրխուան
        </a>
        ներկայումս հասանելի չէ։
      </p>
    </main>
    ...
    <footer>
      <a
        ...
        href="https://www.flaticon.com/free-icons/chinese"
        title="chinese icons"
      >
        Chinese icons created by Freepik - Flaticon
      </a>
    </footer>
  </div>
</template>
